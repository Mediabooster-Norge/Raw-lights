...
export function Footer({ logo, logoDark, footerNav, socialLinks }: FooterProps) {
  return (
    <footer className="bg-surface border-t border-text-secondary/10" role="contentinfo">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-text-secondary/10 mt-12 pt-8 text-center text-text-secondary text-sm">
