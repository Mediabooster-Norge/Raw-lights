...
export default defineType({
  ...
  icon: TranslateIcon,
  fields: [
    defineField({ name: 'sourceDocument', title: 'Kildedokument', type: 'reference', to: [{ type: 'page' }, { type: 'product' }, { type: 'post' }, { type: 'postType' }, { type: 'navigation' }, { type: 'form' }], validation: (Rule) => Rule.required() }),
    ...
    defineField({ name: 'targetDocument', title: 'Engelsk kladd', type: 'reference', to: [{ type: 'page' }, { type: 'product' }, { type: 'post' }, { type: 'postType' }, { type: 'navigation' }, { type: 'form' }], readOnly: true }),
